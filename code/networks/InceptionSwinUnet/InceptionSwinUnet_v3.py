...
iswin_config2 = ml_collections.ConfigDict({
    'ALPHAS': [3/8, 5/8],
    'IMG_SIZE': 512,
    'PATCH_SIZE': 4,
    'IN_CHANS': 3,
...
iswin_config3 = ml_collections.ConfigDict({
    'ALPHAS': [3/8, 4/8, 5/8],
    'IMG_SIZE': 512,
    'PATCH_SIZE': 4,
    'IN_CHANS': 3,
...
iswin_config4 = ml_collections.ConfigDict({
...
iswin_config5 = ml_collections.ConfigDict({
    'ALPHAS': [3/8, 4/8, 5/8, 6/8, 7/8],
    'IMG_SIZE': 512,
    'PATCH_SIZE': 4,
    'IN_CHANS': 3,
    'NUM_CLASSES': 2,
...
if __name__ == '__main__':
    ...
    for config in [iswin_config2, iswin_config3, iswin_config4, iswin_config5]:

        model = InceptionSwinUnet_from_config(config=config)
